            ...
            <div class="ms-auto d-flex align-items-center">
                ...
                <div class="dropdown d-inline-block ms-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-end width-300 pt-0 px-0 sm-mi-45px" aria-labelledby="userprofiledd">
                        ...
                        <div class="px-2">
                            <div>
                                <a class="dropdown-item {{ isActive('user.dashboard') }}" href="{{ route('user.dashboard') }}">
                                    <i data-feather="layout" class="avatar avatar-18 me-1"></i> Dashboard
                                </a>
                            </div>

                            <div>
                                <a class="dropdown-item {{ isActive(['user.wallet.*', 'user.domestic.transfer.*', 'user.wire.transfer.*']) }}" href="{{ route('user.wallet') }}"> <i data-feather="credit-card" class="avatar avatar-18 me-1"></i> View Wallet </a>
                            </div>

                            <div>
                                <a class="dropdown-item {{ isActive('user.profile') }}" href="{{ route('user.profile') }}"> <i data-feather="settings" class="avatar avatar-18 me-1"></i> Account Settings </a>
                            </div>
