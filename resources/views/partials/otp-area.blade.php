...
<div id="otpDisplay" class="d-flex gap-2 mb-3">
...
<div class="keypad-grid">
    ...
    <button type="button" class="keypad-key" id="clearKey">C</button>
    <button type="button" class="keypad-key">0</button>
    <button type="button" class="keypad-key" id="backspaceKey"><i class="bi bi-backspace"></i></button>
</div>

<div class="d-flex justify-content-center align-items-center mt-4">
    <a id="resendOtp" href="javascript:void(0)" class="text-decoration-underline small text-center">Click to resend</a>
</div>
