            ...
            <div class="col-12 col-sm">
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active bi" aria-current="page">Make Transfer</li>
                    </ol>
                </nav>
                <h5>Make Transfer</h5>
            </div>
                    ...
                    <div class="col-12 col-lg-12 mb-4">
                        <div class="card adminuiux-card h-100 rounded-4 border">
                            <div class="card-header">
                                <h6>Domestic Transfer Details</h6>
                            </div>

                            <div class="card-body">
                                <form id="domestic-transfer" action="{{ route('admin.domestic.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col">
                                            <div class="form-floating mb-1">
                                                <input type="text" class="form-control rounded-4 @error('amount') is-invalid @enderror" name="amount" id="domestic_transfer_amount" value="{{ old('amount') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input type="datetime-local" class="form-control rounded-4 @error('date') is-invalid @enderror" name="date" id="transaction_date" value="{{ old('date') }}">
                ...
                fetch(form.action, {
                    ...
                    .then(data => {
                        if (data.status === 'success') {
                            showSuccess(data.message || 'Transfer submitted successfully');
                            setTimeout(() => location.href = "{{ route('admin.domestic') }}", 2000);
                        } else {
                            showError(data.message || 'Failed to submit transfer. Please try again.');
                        }
                    })
                    .catch(error => {
