    ...
    <div class="container mt-4 mb-5" id="main-content">
        <div class="row align-items-center mb-4">
            ...
            <div class="col-6 col-sm text-end">
                <a href="{{ route('admin.domestic.create') }}" class="btn btn-theme">
                    <i class="bi bi-plus-lg"></i> Domestic Transfer
                </a>
            </div>
        </div>
                                ...
                                @forelse($transfers as $transfer)
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            ...
                                            <a href="{{ route('admin.domestic.edit', $transfer->id) }}" class="btn btn-sm btn-outline-primary rounded-4">Edit</a>
