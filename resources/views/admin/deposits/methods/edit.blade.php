            ...
            <div class="col-12 col-sm">
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active bi" aria-current="page">Edit Payment Method</li>
                    </ol>
                </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-12 mb-4">
                        <div class="card adminuiux-card h-100 rounded-4 border">
                            ...
                            <div class="card-body">
                                <form id="payment-method-form" action="{{ route('admin.deposits.methods.update', $wallet['method_code']) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input type="text" class="form-control rounded-4 @error('name') is-invalid @enderror" id="name" name="name" autofocus value="{{ old('name', $wallet['name']) }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-4">
                                                <input type="text" class="form-control rounded-4 @error('abbreviation') is-invalid @enderror" name="abbreviation" id="abbreviation" value="{{ old('abbreviation', $wallet['abbreviation']) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-floating mb-4">
                                                <select class="form-select rounded-4 @error('status') is-invalid @enderror" id="status" name="status">
                                                    <option value="" disabled {{ old('status', $wallet['status']) ? '' : 'selected' }}>Select Wallet Status</option>
                                                    <option value="1" {{ old('status', $wallet['status']) == 1 ? 'selected' : '' }}>Active</option>
                                                    <option value="0" {{ old('status', $wallet['status']) == 0 ? 'selected' : '' }}>Disabled</option>
                                                </select>
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <textarea class="form-control rounded-4 @error('gateway_parameter') is-invalid @enderror" name="gateway_parameter" id="gateway_parameter" rows="3" placeholder="Gateway Parameters">{{ old('gateway_parameter', $wallet['gateway_parameter']) }}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <button type="submit" id="domesticBtn" class="btn btn-theme w-100 rounded-4">
                                                ...
                                                <span class="button-text">Save Wallet</span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener("submit", async (e) => {
                ...
                try {
                    ...
                    showError("An error occurred while updating the payment method.");
                } finally {
