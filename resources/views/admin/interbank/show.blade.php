            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <div class="invoice-box card border rounded-4 p-4 p-md-5">
                    ...
                    <div class="invoice-header text-center border-bottom pb-4 mb-4">
                        <h1 class="h3 fw-bold text-primary mb-2">Interbank Transfer Receipt</h1>
                        <p class="text-muted mb-1">Reference: {{ $transfer->transfer_id }}</p>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <p class="mb-1">{{ $transfer->recipient->first_name }} {{ $transfer->recipient->last_name }}</p>
                            <p class="mb-1">{{ $transfer->recipient->profile->account_number }}</p>
                            <p class="mb-1">{{ $transfer->recipient->profile->account_type ?? 'Savings Account' }}</p>
                            <p class="mb-0">Bank: {{ config('app.name') }}</p>
                        </div>
                    </div>
                        ...
                        <div class="card border border-1 rounded-3">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between border-bottom py-2">
                                    ...
                                    <span class="text-muted fs-xs">{{ $transfer->transfer_id }}</span>
                                </div>
                    ...
                    <div class="text-center no-print">
                        <a href="{{ route('admin.interbank') }}" class="btn btn-outline-primary px-4 rounded-4">
