...
<html lang="en">
    <head>
        ...
        <title>Goal Deleted Confirmation</title>
    </head>
    <body>
        <style>
            html,
                    ...
                    <td align="left" valign="center">
                        <div style="text-align: left; margin: 0 20px; padding: 40px; background-color: #ffffff; border-radius: 6px;">
                            ...
                            <div style="padding-bottom: 30px; font-size: 18px;">
                                <strong>🎯 Your Goal Has Been Deleted!</strong>
                            </div>
                            <div style="padding-bottom: 40px; font-family: Poppins, Helvetica, sans-serif; font-size: 14px;">
                                <p>Hi {{ $goal->user->first_name }},</p>
                                <p>Your goal "<strong>{{ $goal->title }}</strong>" has been successfully deleted.</p>
                                <p>Please ensure that your current savings were successfully withdrawn to your balance before deleting this goal, as deleted funds cannot be recovered. If this action was unintentional or you need help, please contact our support team immediately.</p>
                                <p>
                                    <a href="{{ route('user.goal') }}" role="button" style="display: inline-block; padding: 10px 20px; background: #28a745; color: white; text-decoration: none; border-radius: 5px; font-size: 14px;">View My Goals</a>
                                </p>
                            </div>
