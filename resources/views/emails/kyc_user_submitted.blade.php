                    ...
                    <td align="left" valign="center">
                        <div style="text-align: left; margin: 0 20px; padding: 40px; background-color: #ffffff; border-radius: 6px;">
                            ...
                            <div style="padding-bottom: 30px; font-size: 18px;">
                                <strong>KYC Submission Received</strong>
                            </div>
                            <div style="padding-bottom: 40px; font-family: Poppins, Helvetica, sans-serif; font-size: 14px;">
                                <p>Dear {{ $user->first_name }},</p>
                                <p>We have successfully received your KYC submission. Our team will review your documents and get back to you shortly.</p>
                                <p><strong>Submission Details:</strong></p>
                                <ul>
                                    <li><strong>Reference ID:</strong> {{ $kyc->id }}</li>
                                    <li><strong>Submission Date:</strong> {{ $kyc->created_at->format('F j, Y, g:i A T') }}</li>
                                    <li><strong>Status:</strong> Pending Review</li>
                                </ul>
                                <p>If you have any questions, please contact our support team.</p>
                                <p>
                                    <a href="{{ route('user.kyc') }}" role="button" style="display: inline-block; padding: 10px 20px; background: #4299e1; color: white; text-decoration: none; border-radius: 5px; font-size: 14px;">View KYC Status</a>
                                </p>
                            </div>
