...
<head>
    ...
    <title>Wire Transfer Status Confirmation</title>
</head>
<body>
<style>
    html,
                ...
                <div style="text-align: left; margin: 0 20px; padding: 40px; background-color: #ffffff; border-radius: 6px;">
                    ...
                    <div style="padding-bottom: 40px; font-family: Poppins, Helvetica, sans-serif; font-size: 14px;">
                        @if($transfer->trans_status === 'approved')
                            <p>Your wire transfer has been successfully approved with the following details:</p>
                        @else
                            <p>Your wire transfer has been rejected with the following details:</p>
                        @endif
                        <table cellpadding="8" cellspacing="0" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px;">{{ Str::title(str_replace('_', ' ', $transfer->acct_country)) }}</td>
                            </tr>
                            <tr style="background: #f0f0f0;">
                                <td style="padding: 8px;"><strong>SWIFT Code:</strong></td>
                                <td style="padding: 8px;">{{ $transfer->acct_swift }}</td>
                            </tr>
                            <tr>
                                <td style="padding: 8px;"><strong>Routing Number:</strong></td>
                                <td style="padding: 8px;">{{ $transfer->acct_routing }}</td>
                            </tr>
                            <tr style="background: #f0f0f0;">
