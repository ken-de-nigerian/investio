                    ...
                    <td align="left" valign="center">
                        <div style="text-align: left; margin: 0 20px; padding: 40px; background-color: #ffffff; border-radius: 6px;">
                            ...
                            <div style="padding-bottom: 40px; font-family: Poppins, Helvetica, sans-serif; font-size: 14px;">
                                <p>Your deposit request has been successfully received and is being processed.</p>
                                <p><strong>Transaction Details:</strong></p>
                                <ul>
                                    <li>Amount: <strong>{{ number_format($deposit->amount, 2) }} USD</strong></li>
                                    <li>Payment Method: <strong>{{ $deposit->payment_method }}</strong></li>
                                    <li>Transaction ID: <strong>{{ $deposit->transaction_id }}</strong></li>
                                    <li>Status: <strong>{{ ucfirst($deposit->status) }}</strong></li>
                                </ul>
                                <p>If you did not initiate this deposit, please contact our support team immediately.</p>
                                <p>
                                    <a href="{{ route('user.wallet') }}" role="button" style="display: inline-block; padding: 10px 20px; background: #4a90e2; color: white; text-decoration: none; border-radius: 5px; font-size: 14px;">View Deposit History</a>
                                </p>
                            </div>
