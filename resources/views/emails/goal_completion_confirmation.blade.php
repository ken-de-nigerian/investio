                    ...
                    <td align="left" valign="center">
                        <div style="text-align: left; margin: 0 20px; padding: 40px; background-color: #ffffff; border-radius: 6px;">
                            ...
                            <div style="padding-bottom: 40px; font-family: Poppins, Helvetica, sans-serif; font-size: 14px;">
                                ...
                                <p>We're happy to let you know that your savings goal "<strong>{{ $goal->title }}</strong>" has been completed.</p>
                                <p>The amount of <strong>${{ number_format($goal->current_amount, 2) }}</strong> has been successfully withdrawn and added to your main balance.</p>
