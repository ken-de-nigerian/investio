        ...
        <div class="row justify-content-center min-vh-100">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 position-relative" style="z-index: 1;">
                <div class="text-center mb-4 mt-4">
                    <h2 class="text-primary fw-bold">Welcome to Our Platform</h2>
                    <p class="text-muted">Complete your profile to get started</p>
                    <a class="d-inline-flex w-auto mx-auto style-none" href="{{ route('home') }}">
                ...
                <div class="card adminuiux-card border rounded-4 position-relative" style="z-index: 2;">
                    <div class="card-body z-index-1 p-4">
                        <form id="onboardingForm" method="POST" action="{{ route('onboarding.store') }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="step-content" id="stepContent1">
                                ...
                                <div class="text-center mb-4">
                                    <div class="position-relative d-inline-block" style="width: 120px; height: 120px;">
                                        <div class="rounded-circle overflow-hidden w-100 h-100 border border-2 border-light shadow-sm" style="cursor: pointer;" onclick="document.getElementById('avatar').click()">
                                            <img id="avatarPreview" class="w-100 h-100" style="object-fit: cover;" alt="Profile" src="{{ $avatar ?? asset('images/default-avatar.png') }}">
                                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('first_name') is-invalid @enderror" id="firstName" name="first_name" value="{{ old('first_name', $auth['user']->first_name ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('last_name') is-invalid @enderror" id="lastName" name="last_name" value="{{ old('last_name', $auth['user']->last_name ?? '') }}">
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="email" class="form-control rounded-4 @error('email') is-invalid @enderror" id="email" value="{{ old('email', $auth['user']->email ?? '') }}" readonly>
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="tel" class="form-control rounded-4 @error('phone_number') is-invalid @enderror" id="phoneNumber" name="phone_number" value="{{ old('phone_number', $auth['user']->phone_number ?? '') }}" autofocus>
                            ...
                            <div class="step-content d-none" id="stepContent2">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select rounded-4 @error('account_type') is-invalid @enderror" id="accountType" name="account_type">
                                                <option value="">Select Account Type</option>
                                                <option value="Savings" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Savings' ? 'selected' : '' }}>Savings Account</option>
                                                <option value="Current" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Current' ? 'selected' : '' }}>Current Account</option>
                                                <option value="Checking" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Checking' ? 'selected' : '' }}>Checking Account</option>
                                                <option value="Fixed Deposit" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Fixed Deposit' ? 'selected' : '' }}>Fixed Deposit</option>
                                                <option value="Non Resident" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Non Resident' ? 'selected' : '' }}>Non Resident Account</option>
                                                <option value="Online Banking" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Online Banking' ? 'selected' : '' }}>Online Banking</option>
                                                <option value="Domiciliary Account" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Domiciliary Account' ? 'selected' : '' }}>Domiciliary Account</option>
                                                <option value="Joint Account" {{ old('account_type', $auth['user']->profile->account_type ?? '') == 'Joint Account' ? 'selected' : '' }}>Joint Account</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="date" class="form-control rounded-4 @error('date_of_birth') is-invalid @enderror" id="dateOfBirth" name="date_of_birth" value="{{ old('date_of_birth', $auth['user']->profile->date_of_birth ?? '') }}" max="{{ date('Y-m-d', strtotime('-18 years')) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select rounded-4 @error('gender') is-invalid @enderror" id="gender" name="gender">
                                                ...
                                                <option value="female" {{ old('gender', $auth['user']->profile->account_type ?? '') == 'female' ? 'selected' : '' }}>Female</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select rounded-4 @error('marital_status') is-invalid @enderror" id="maritalStatus" name="marital_status">
                                                ...
                                                <option value="single" {{ old('marital_status', $auth['user']->profile->marital_status ?? '') == 'single' ? 'selected' : '' }}>Single</option>
                                                <option value="married" {{ old('marital_status', $auth['user']->profile->marital_status ?? '') == 'married' ? 'selected' : '' }}>Married</option>
                                            </select>
                            ...
                            <div class="step-content d-none" id="stepContent3">
                                            ...
                                            <select class="form-select rounded-4 @error('country') is-invalid @enderror" id="country" name="country">
                                                ...
                                                @foreach($countries as $country)
                                                    <option value="{{ Str::snake($country['name']) }}"
                                                        {{ old('country', $auth['user']->profile->country ?? '') == Str::snake($country['name']) ? 'selected' : '' }}>
                                                        {{ $country['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('state') is-invalid @enderror" id="state" name="state" value="{{ old('state', $auth['user']->profile->state ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('city') is-invalid @enderror" id="city" name="city" value="{{ old('city', $auth['user']->profile->city ?? '') }}">
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control rounded-4 @error('address') is-invalid @enderror" id="address" name="address" style="height: 100px">{{ old('address', $auth['user']->profile->address ?? '') }}</textarea>
                            ...
                            <div class="step-content d-none" id="stepContent4">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('occupation') is-invalid @enderror" id="occupation" name="occupation" value="{{ old('occupation', $auth['user']->profile->occupation ?? '') }}">
                                ...
                                <div class="row g-3 mt-3">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control rounded-4 @error('social_security_number') is-invalid @enderror" id="socialSecurityNumber" name="social_security_number" value="{{ old('social_security_number', $auth['user']->profile->social_security_number ?? '') }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            <div class="d-inline-block">
                                                <img id="previewAvatar" class="rounded-circle border border-2 border-light shadow-sm" style="width: 100px; height: 100px; object-fit: cover;" alt="Profile Preview" src="{{ $avatar ?? asset('images/default-avatar.png') }}">
                                            </div>
