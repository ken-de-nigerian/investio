            ...
            <div class="col-12 col-sm">
                <nav aria-label="breadcrumb" class="mb-2">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active bi" aria-current="page">Domestic Transfer</li>
                    </ol>
                </nav>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <form id="domestic-transfer">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col">
                                            <div class="form-floating mb-1">
                                                <input type="text" class="form-control rounded-4 @error('amount') is-invalid @enderror" name="amount" id="domestic_transfer_amount" value="{{ old('amount') }}" onkeyup="this.value = this.value.replace (/^\.|[^\d.]/g, '')">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <button type="submit" id="domesticBtn" class="btn btn-theme w-100 rounded-4">Transfer</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <!-- Domestic Transfers History Card -->
                    <div class="col-12 col-lg-12 mb-4">
                        <div class="card adminuiux-card rounded-4 border h-100">
                            <div class="card-header border-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6>Recent Domestic Transfers</h6>
                                    </div>

                                    <div class="col-auto">
                                        <select class="form-select form-select-sm rounded-pill border" id="sortSelectDomestic" onchange="sortTransfers('domestic', this.value)">
